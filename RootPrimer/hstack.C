...
//
void hstack(){
    THStack *a = new THStack("a", "Stacked 2D Histogram_a");

    TF2 *f1 = new TF2("f1","xygaus + xygaus(5) + xylandau(10)",-4,4,-4,4);
    Double_t params1[]={130,-1.4,1.8,1.5,1,150,2,0.5,-2,.5,3600,-2,.7,-3,.3};
    ...
    Double_t params2[]={100,-1.4,1.9,1.1,2,80,2,.7,-2,.5};
