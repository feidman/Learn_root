// File an n-tuple and write it to a file simulating measurement of 
...
void write_ntuple_to_file(){
	...
	cur=gRandom->Uniform(0.5,1.5);   // get pressure
	cur = pot/(10.+0.05*(temp-300.0)-0.2*(pres-1.0)); // caculate the current
